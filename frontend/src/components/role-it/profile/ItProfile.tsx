...
import ItMetaCard from "./ItMetaCard";
import ItInfoCard from "./ItInfoCard";
...
export default function UserProfile() {
  ...
  const [user, setUser] = useState<ProfileIt | null>(null);
  ...
  function handleProfileUpdated(updatedUser: ProfileIt) {
    setUser(updatedUser);
