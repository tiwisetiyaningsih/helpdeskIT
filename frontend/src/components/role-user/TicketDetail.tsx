...
async function downloadEvidence(fileUrl: string, fileName: string) {
  try {
    const response = await apiFetch(fileUrl);

    if (!response.ok) {
      throw new Error("Gagal mengunduh evidence.");
    }
...
function formatDuration(value?: string | number | null, unit = "menit") {
...
function getStatusDescription(status?: string) {
  ...
  return (
    descriptions[normalizeStatus(status)] || "Status ticket tidak diketahui."
  );
}
...
function getTimeline(ticket: Ticket): TimelineItem[] {
  ...
  return [
    ...
    },
    {
      status: "OPEN",
      label: "Open",
      date: getStatusLevel(normalized) >= 2 ? ticket.updatedAt || null : null,
    },
    {
      status: "ON_GOING",
      label: "On Going",
    ...
    },
    {
      status: "PENDING",
      label: "Pending",
      date: normalized === "PENDING" ? ticket.updatedAt || null : null,
    },
    {
      status: "COMPLETED",
      label: "Completed",
...
function getSlaProgress(ticket: Ticket) {
  ...
  const absoluteMinutes = Math.ceil(Math.abs(remainingMilliseconds) / 60000);
  const hours = Math.floor(absoluteMinutes / 60);
  const minutes = absoluteMinutes % 60;
  const remainingText = `${hours > 0 ? `${hours} jam ` : ""}${minutes} menit`;
...
export default function TicketDetail({ ticket, onClose }: TicketDetailProps) {
  ...
  return (
    ...
    >
          ...
          <div className="min-w-0">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                onClick={() => {
                  void navigator.clipboard.writeText(ticket.noPelaporan);
                }}
          ...
          <div className="space-y-4 p-4 sm:p-6">
            ...
            <section className="overflow-x-auto">
              <div className="flex min-w-[760px] items-start">
                {timeline.map((item, index) => {
                  ...
                  return (
                    <div key={item.status} className="flex flex-1 items-start">
            ...
            >
              <div className="grid grid-cols-1 gap-x-8 gap-y-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <DetailValue label="Jabatan" value={employee?.jabatan || "-"} />
                <DetailValue
                  label="Unit Kerja"
                ...
                />
                <DetailValue label="NIK" value={employee?.nik || "-"} />
                <DetailValue
              ...
              >
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <DetailValue
                    ...
                    value={ticket.kategoriKeluhan || "Belum ditentukan"}
              ...
              >
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div className="flex items-center gap-3">
                    ...
                    <DetailValue
                      ...
                      secondary={
                        ...
                        (ticket.handlerId ? "IT HelpDesk" : "Belum ditugaskan")
                      }
                    />
                  </div>
                  ...
                  <DetailValue
                    ...
                    secondary={formatDateTime(ticket.batasResponse)}
                  />
                  ...
                  <DetailValue
                    ...
                    value={formatDateTime(ticket.estimasiPengerjaan)}
                  />
                </div>
                ...
                <div className="mt-5">
                  ...
                  <p className={`mt-2 text-[11px] ${slaProgress.textClass}`}>
              ...
              >
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2 lg:grid-cols-4">
                  <DetailValue
                    ...
                    value={formatDateTime(ticket.mulaiPengerjaan)}
                    icon={<CalendarIcon />}
                  />
                  <DetailValue
                    label="Estimasi"
                  ...
                  <DetailValue
                    ...
                    value={formatDateTime(ticket.selesaiPengerjaan)}
                  />
                  <DetailValue
                  ...
                  <DetailValue
                    label="Lama Pending"
                    value={formatDuration(ticket.lamaPending, "menit")}
                  />
                  <DetailValue
                    label="Waktu Pengerjaan"
                    value={formatDuration(ticket.waktuPengerjaan, "menit")}
                  />
                  <DetailValue
              ...
              >
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  ...
                  <DetailValue
                    ...
                    value={ticket.keteranganResponse || "-"}
                  />
                </div>
              </DetailSection>
                ...
                {!ticket.evidences || ticket.evidences.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    {ticket.evidences.map((evidence) => {
                      ...
                      // Nama yang ditampilkan pakai nama hasil hash dari
                      // MinIO (evidence.fileName), bukan nama asli upload.
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              >
                <div className="space-y-4">
                  <TextBlock label="Analisa Awal" value={ticket.analisaAwal} />
                  <TextBlock
                    label="Hasil Analisa"
              ...
              >
                <div className="space-y-4">
                  <TextBlock label="Catatan" value={ticket.catatan} />
                  <TextBlock label="Keterangan" value={ticket.keterangan} />
                </div>
              </DetailSection>
            </div>
          </div>
      ...
      {/* Lightbox preview evidence gambar */}
      {previewImage && (
        <div
