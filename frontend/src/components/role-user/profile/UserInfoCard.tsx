...
type UserInfoCardProps = {
  user: ProfileUser;
  onUserUpdated: (updatedUser: ProfileUser) => void;
};
  ...
  return (
    <>
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
        ...
        {/* <div className="mt-8 rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-white/[0.03]">
          <p className="text-theme-sm font-medium text-gray-800 dark:text-white/90">
            Informasi
          </p>

          <p className="mt-1 text-theme-xs leading-5 text-gray-500 dark:text-gray-400">
            NIK, jabatan, unit kerja, role, dan status akun hanya
